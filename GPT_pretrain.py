#!/usr/bin/env python3
"""
GPT_pretrain.py — GPT-Naylis v1 (standard, sans graph)
========================
Pretrain NaylisGPT ~125M params sur Cosmopedia v2.
...
CONFIG = {
    ...
    'use_flash_attn'        : True,
    'rel_rank'              : 32,
    'use_graph'             : False,  # désactivé — transformer classique
    # Tokens spéciaux
    ...
    # Checkpoint
    'checkpoint_file'       : './Model/GPT_pretrain.pt',
    # Compile
...
print('=' * 70)
print('  GPT-Naylis v1 — Pretrain (standard, sans graph)')
print('=' * 70)
if DEVICE == 'cuda':
